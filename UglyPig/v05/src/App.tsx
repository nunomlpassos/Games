...
export default function App() {
  ...
  }, [playTone, isPaused, countdown, resetRun]);
    ...
    <div className="w-full h-screen bg-sky-300 flex items-center justify-center overflow-hidden">
      <div className="flex flex-col items-center">
        ...
        >
          ...
          {!renderState.isGameOver && countdown === null && (
            <button
              type="button"
          ...
          {countdown !== null && (
            <div className="absolute inset-0 z-50 bg-black/35 flex items-center justify-center pointer-events-none">
              <div
                className="text-white font-black drop-shadow-[0_4px_6px_rgba(0,0,0,0.7)] transition-all duration-300"
                style={{
                  fontSize: "120px",
                  transform: `scale(${1 + (4 - Math.max(countdown, 1)) * 0.25})`,
                }}
              >
                {countdown}
              </div>
