...
export default function App() {
  ...
  const playTone = useCallback((freq: number, duration = 0.08, type: OscillatorType = "square") => {
    try {
  ...
  return (
    <div className="w-full h-screen bg-sky-300 flex items-center justify-center overflow-hidden">
      <div className="flex flex-col items-center">
        ...
        {/* Bottom centered score (no box) */}
        <div className="mt-3 text-4xl font-black text-amber-900 drop-shadow-md leading-none select-none">
          {renderState.score}
        </div>
      </div>
    </div>
