    ...
    >
      ...
      <div
        ...
        style={{
          ...
          top: `${size * 0.33}px`,
          left: direction === 1 ? `${size * 0.42}px` : `${size * 0.08}px`,
        }}
      >
        <div className="absolute bg-pink-700 rounded-full" style={{ width: `${size * 0.08}px`, height: `${size * 0.08}px`, top: `${size * 0.06}px`, left: `${size * 0.12}px` }} />
        <div className="absolute bg-pink-700 rounded-full" style={{ width: `${size * 0.08}px`, height: `${size * 0.08}px`, top: `${size * 0.06}px`, right: `${size * 0.12}px` }} />
      </div>
      ...
      <div
        ...
        style={{
          ...
          height: `${size * 0.1}px`,
          top: `${size * 0.22}px`,
          left: direction === 1 ? `${size * 0.6}px` : `${size * 0.28}px`,
        }}
      />
    </div>
  );
