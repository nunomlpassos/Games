...
export default function App() {
  ...
  }, [playTone, playPigHitSound, triggerVibration, isPaused, countdown, hasStarted, gameSize.width, gameSize.height, PIG_Y]);
